<%-- 
    Document   : graficoAlumno
    Created on : 10 oct. 2023, 18:59:55
    Author     : abdel
--%>
...
<html>
    <head>
        ...
        <title>Gráfico de Alumnos</title>
        ...
        <link href="/SistemaUniversidad/css/grafico.css" rel="stylesheet" type="text/css"/>
    </head>
    <body id="inicio">
        ...
        <main>
            <section class="titulo">
                <div class="banner-wrapper">
                    <div class="texto">
                        <h1>Gráfico de Alumnos</h1>
                    </div>
                </div>
            </section>

            <section class="grafico">
                <h1>Cantidad de alumnos en cada carrera profesional</h1>
                <form action="Grafico1.jsp" target="zona">
                    <input type="radio" name="op" value="bar" onclick="submit()">Barras
                    <input type="radio" name="op" value="pie" onclick="submit()">Círculo
